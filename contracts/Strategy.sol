...
contract Strategy  is Ownable, Pausable {
    ...
    address public constant token0 = address(0x0000000000000000000000000000000000000000);
    address public want;
    ...
    function addLiquidity() internal {
        ...
        uint256 t2Bal = IERC20(token0).balanceOf(address(this));

        IGlacierRouter(router).addLiquidity(wavax, token0, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
